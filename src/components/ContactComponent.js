...
class Contact extends Component {
    ...
    // //because passing in arg other than event, need to wrap in another function
    // handleBlur = (field) => () => {
    //     this.setState({
                    ...
                    <div className="col-md-10">
                        <LocalForm onSubmit={values=>this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".phoneNumber" className="form-control" id="phoneNum" name="phoneNum"
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea id="feedback" name="feedback" model=".feedback" className="form-control"
                                        rows="12"/>
                                </Col>
                            </Row>
                            <Row className="form-group">
